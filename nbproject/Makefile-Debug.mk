...
LDLIBSOPTIONS=-L/Library/Frameworks -Llibs
...
${OBJECTDIR}/hgp/common/inputmanager.o: hgp/common/inputmanager.cpp 
	${MKDIR} -p ${OBJECTDIR}/hgp/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/Library/Frameworks/SDL2.framework/Headers -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hgp/common/inputmanager.o hgp/common/inputmanager.cpp
...
${OBJECTDIR}/hgp/common/statelistenerqueue.o: hgp/common/statelistenerqueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/hgp/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/Library/Frameworks/SDL2.framework/Headers -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hgp/common/statelistenerqueue.o hgp/common/statelistenerqueue.cpp
...
${OBJECTDIR}/hgp/interface/widget.o: hgp/interface/widget.cpp 
	${MKDIR} -p ${OBJECTDIR}/hgp/interface
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/Library/Frameworks/SDL2.framework/Headers -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hgp/interface/widget.o hgp/interface/widget.cpp
